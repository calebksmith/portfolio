 ...
 * Landing page.
 *
 * Static server component — no application JavaScript ships for this route.
 * The staggered entrance is CSS only (`.ck-enter` + `--ck-enter-index`), so it
 * costs nothing at runtime and disappears entirely under prefers-reduced-motion
